...
public class test extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        obj.showMessage("Confirm Deletion", "Are you sure you want to delete the event?", "This action will permanently remove all associated data. This action is irreversible.");
        if(obj.getMessageType() == Message.MessageType.YESDELETE) {
