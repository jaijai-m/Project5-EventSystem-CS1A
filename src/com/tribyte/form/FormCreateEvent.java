...
public class FormCreateEvent extends JPanel {
    ...
    public FormCreateEvent() {
        ...
        chkNo.setSelected(true);      // No code required
        chkOpen.setSelected(true);    // Event is Open
        ...
        ActionListener checkListener = e -> {
            txtInsertCode.setVisible(chkYes.isSelected());
            panelRound1.revalidate();
            panelRound1.repaint();
        };

        chkYes.addActionListener(checkListener);
        chkNo.addActionListener(checkListener);
